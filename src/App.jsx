...
export default function App() {
  ...
  // 🌅 Determine sunrise/sunset phases based on local system time
  useEffect(() => {
    ...
    determineTimeMode();
    const timer = setInterval(determineTimeMode, 5 * 60 * 1000); // update every 5 minutes
  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      {/* 🔥 Dynamic PESKY Header (Sunrise/Day/Sunset/Night) */}
      <header
        className={`
